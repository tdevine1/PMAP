...
INSERT INTO `answers` VALUES (1,'newdev1','2','New Dev SelfEval','5/9/2016','dlsfjb','ifdsjab','1','2','2','2','2','1','1','1','The','is','a','demo',NULL,NULL,NULL,NULL,NULL),(1,'sblankenship3','1','Samuel Blankenship SelfEval','5/9/2016','Samuel Blankenship','PMAP','1','3','3','3','2','2','2','2','I','Still','Work','Right',NULL,NULL,NULL,NULL,NULL),(2,'sblankenship3','1','Samuel Blankenship PeerEvalOf  Quintin Nicholson','5/9/2016','Quintin Nicholson','PMAP','1','2','1','2','1','2','1','2','Peer','Works','As','Well',NULL,NULL,NULL,NULL,NULL),(2,'sblankenship3','1','Samuel Blankenship PeerEvalOf Alisa Taylor','5/9/2016','Alisa Taylor','PMAP','1','1','1','1','1','1','1','1','Alica has been excellent in all category','None','Communication and task scheduling','No',NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `assessments` VALUES ('selfAssessment',1,'COMP4400'),('peerAssessment',2,'COMP4400');
...
INSERT INTO `course` VALUES ('COMP4400','S2016','Software Engineering');
...
INSERT INTO `dev` VALUES ('1','cbrowning4'),('1','sblankenship3'),('2','newdev1');
...
INSERT INTO `group` VALUES ('1','PMAP','Alisa Taylor, Andrew Lyon, Chris Browning, Lesley Kuffour, Quintin Nicholson, Samuel Blankenship'),('2','CoolThing','New Guy, New Person, New Dev');
...
CREATE TABLE `groupsincourse` (
  `CID` varchar(15) NOT NULL,
  `semester` varchar(45) NOT NULL,
  `GIDs` varchar(15) NOT NULL,
  PRIMARY KEY (`CID`,`semester`,`GIDs`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `groupsincourse` VALUES ('COMP4400','S2016','1'),('COMP4400','S2016','2');
...
--
-- Table structure for table `presentationgrades`
--

DROP TABLE IF EXISTS `presentationgrades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `presentationgrades` (
  `GID` varchar(15) NOT NULL,
  `Evaluator` varchar(45) NOT NULL,
  `Points_earned` double NOT NULL,
  `Points_possible` double NOT NULL,
  `weighting` double NOT NULL,
  PRIMARY KEY (`GID`,`Evaluator`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `presentationgrades`
--

LOCK TABLES `presentationgrades` WRITE;
/*!40000 ALTER TABLE `presentationgrades` DISABLE KEYS */;
INSERT INTO `presentationgrades` VALUES ('1','Ted',49,50,0.3),('1','Tim',40,50,0.4),('1','Tom',45,50,0.3),('2','Ted',45,50,0.3),('2','Tim',30,50,0.4),('2','Tom',45,50,0.3);
/*!40000 ALTER TABLE `presentationgrades` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `projectmanager` VALUES ('1','alyon1'),('1','ataylor1'),('1','lkuffour1'),('1','qnicholson1'),('2','newperson1'),('2','newperson2');
...
INSERT INTO `stakeholder` VALUES ('1','tdevine');
...
INSERT INTO `users` VALUES ('alyon1','pass1','Andrew','Lyon'),('ataylor1','pass1','Alisa','Taylor'),('cbrowning4','Ir0nk3y1991','Christopher','Browning'),('lkuffour1','pass1','Lesley','Kuffour'),('newdev1','ZWBUI9DU','New','Dev'),('newperson1','1PTUH7SZ','New','Guy'),('newperson2','SP23WHAE','New','Person'),('qnicholson1','pass1','Quintin','Nicholson'),('sblankenship3','Gurren$5','Samuel','Blankenship'),('tdevine','admin','Tom','Devine');
...
-- Dump completed on 2016-05-10  5:32:15
